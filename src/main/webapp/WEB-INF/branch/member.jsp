                    ...
                    <div class="x_content">
                        <form action="#">
                            ...
                            <table id="datatable-branches"
                                ...
                                <thead>
                                <tr>
                                    <th style="width:5%;text-align:center;">ชื่อผู้ใช้</th>
                                    <th style="width:20%;text-align:center;">หน้าที่</th>
            ...
            success: function (json) {
                ...
                for (var iterator = 0; iterator < json.length; iterator++) {
                    ...
                    var data_refresh = {
                        ...
                        '<a onclick = "del_branch(' + obj.branchNo + ',\'' + obj.branchName +'\')" class = "btn btn-warning btn-sm"> <i class = "fa fa-pencil"></i> &nbsp; แก้ไข </a>' +
