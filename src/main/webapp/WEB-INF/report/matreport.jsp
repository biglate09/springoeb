...
<head>
    ...
    <title>รายงานวัตถุดิบอาหาร</title>
        ...
        <div class="right_col" role="main">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <div class="col-md-7"><h2>ประเภทวัตถุดิบ</h2></div>
                            <div class="col-md-2">
                        ...
                        <div class="x_content">
                            <div id="pie_mattype" style="height:400px;"></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <div id="pie_mat" style="height:400px;"></div>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    //echart Pie
    //***********CONFIG BY BIGHEAD*************//
    var limit_of_type = 10;
    var mattype_data_legends = [];
    var mattype_data_series = [];
    var limit_of_mat = 20;
    var mat_data_legends = [];
    var mat_data_series = [];
    //***********CONFIG BY BIGHEAD*************//
        ...
        $.ajax({
            ...
            success: function (menuArray) {
                ...
                for (var i = 0; i < menuArray.length; i++) { // loop menu
                    ...
                    if (index_menu < limit_of_type) {
                        for (key in menu) { // get key
                            value = menu[key];
                            if (value > 0) {
                                //push into array for display
                                mattype_data_legends.push(key);
                                mattype_data_series.push({
                                    name: key,
                                    value: value
                                });
                                index_menu++;
        ...
        $.ajax({
            ...
            success: function (menuArray) {
                ...
                for (var i = 0; i < menuArray.length; i++) { // loop menu
                    ...
                    if (index_menu < limit_of_menu) {
                        for (key in menu) { // get key
                            ...
                            if (value > 0) {
                                //push into array for display
                                mat_data_legends.push(key);
                                mat_data_series.push({
                                    name: key,
                                    value: value
                                });
                                index_menu++;
                ...
                if ($('#pie_mat').length) {
                    ...
                    var echartPie = echarts.init(document.getElementById('pie_mat'));
