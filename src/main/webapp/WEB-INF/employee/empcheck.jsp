                            ...
                            <div class="x_content">
                                <table id="datatable_check" class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <th class="table-rows">ช่วงเวลาทำงาน</th>
                                    ...
                                    <c:forEach items="${employeeTables}" var="et">
                                        <tr>
                                            ...
                                            <fmt:formatDate value="${et.timeStart}" var="timeStartOrder"
                                                            pattern="HHmm"/>
                                            <td style="text-align:center;" data-value="${timeStartOrder}" data-order="${et.timeStart == "00:00:00" ? "0" : et.timeStart == "13:00:00" ? "1" : "2"}">
                                                    ${et.timeStart == "00:00:00" ? "ช่วงเช้า" : et.timeStart == "13:00:00" ? "ช่วงบ่าย" : "ทั้งวัน"}
                                            </td>
