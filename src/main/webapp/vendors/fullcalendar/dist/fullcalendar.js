...
// Do these segments occupy the same vertical space?
    ...
    var View = FC.View = Class.extend(EmitterMixin, ListenerMixin, {
        ...
        updateTitle: function() {
            ...
            for(var monthIterator = 0 ; monthIterator < 12 ; monthIterator ++){
                var monthTH = monthsTH[monthIterator];
                var monthEN = monthsEN[monthIterator];
                if(this.title.indexOf(monthEN) != -1){
                    this.title = this.title.replace(monthEN,monthTH);
                    break;
                }
            }
    ...
    Calendar.defaults = {
        ...
        buttonText: {
            ...
            prevYear: "ปีก่อนหน้า",
            nextYear: "ปีถัดไป",
            year: 'ปี', // TODO: locale files need to specify this
            today: 'วันนี้',
            month: 'เดือน',
            week: 'สัปดาห์',
            day: 'วัน'
...
// from largest to smallest
    ...
    fcViews.list = {
        ...
        defaults: {
            buttonText: 'ลิสต์', // text to display for English
