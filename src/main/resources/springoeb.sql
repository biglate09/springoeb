...
(194, '2017-07-30', NULL, NULL, 520.00, 13, 0, 1, NULL),
...
(226, '2017-08-01', NULL, NULL, 210.00, 6, 0, 19, NULL),
...
(259, '2017-08-06', NULL, NULL, 190.00, 6, 20, 11, NULL),
(260, '2017-08-06', NULL, NULL, 300.00, 5, 0, 13, NULL),
(261, '2017-08-06', NULL, NULL, 485.00, 5, 0, 14, NULL);
...
ALTER TABLE `menu`
  ...
  ADD KEY `menuTypeNo` (`menu_cat_no`);
...
--
-- Indexes for table `menu_menu_set`
--
ALTER TABLE `menu_menu_set`
...
--
ALTER TABLE `employee_pay`
  MODIFY `emp_pay_no` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
--
...
--
ALTER TABLE `work_history`
  MODIFY `work_hist_no` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=262;
--
...
--
ALTER TABLE `menu`
  ADD CONSTRAINT `menu_ibfk_1` FOREIGN KEY (`menu_cat_no`) REFERENCES `menu_category` (`menu_cat_no`);
...
--
-- Constraints for table `menu_menu_set`
--
ALTER TABLE `menu_menu_set`
  ADD CONSTRAINT `menu_menu_set_ibfk_1` FOREIGN KEY (`menu_no`) REFERENCES `menu` (`menu_no`),
  ADD CONSTRAINT `menu_menu_set_ibfk_2` FOREIGN KEY (`menu_set_no`) REFERENCES `menu_set` (`menu_set_no`);
...
ALTER TABLE `work_history`
  ...
  ADD CONSTRAINT `work_history_ibfk_2` FOREIGN KEY (`emp_time_no`) REFERENCES `employee_table` (`emp_time_no`) ON DELETE CASCADE ON UPDATE CASCADE;
